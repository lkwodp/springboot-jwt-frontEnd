...
const validateUsername = (rule,value,callback) =>{
  if(value === ''){
    ...
    callback(new Error('用户名不能包含特殊字符，只能是中英文+数字'))
  }else {
    callback()
  }
}
...
const rule = {
  username:[
    ...
    {min:1,max:20,message:'用户名的长度必须在1-20之间',trigger:['blur','change']}
  ],
  password:[
...
<template>
  <div style="text-align: center;margin: 0 20px">
    <div style="margin-top: 100px">
      ...
      <div style="margin-top: 5px;font-size: 14px;color: grey">欢迎注册该系统，请在下方填写相关信息</div>
    </div>
